...
*******************************************************************************/
  ...
  var newArr = []; // make sure to indent when entering a function! -MM

  for(var i = 0; i < array.length; i += 1){

    for(var e = i + 1; e < array.length; e += 1){
      var sum = array[i] + array[e]; // nice intermediate variable naming
...
}  // watch opening and closing brackets = they need to vertically align - MMM
