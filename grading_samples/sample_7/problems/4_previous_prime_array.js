...
*******************************************************************************/
// don't know how to get the prime before n  // <-- you got it! - MM
// I would name this"previousPrime" or something simliar. "is" implies a boolean return value -MM
function isEarlierPrime(n) {
    for (var i = n - 1; i > 1; i--) {
      if (isPrime(i) === true) {
        return i;
      break; // not necessary to break here, will already return - MM
    }
  }
}
...
function previousPrimeArray(array) { // great decomposition here. great variable naming, clear and readable - MM
