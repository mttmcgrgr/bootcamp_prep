...
function isPrime(number) { // nice decompisiton - MM

  if (number === 2) {
    return true;
  }
                          // you can reduce some of this empty space - MM
...
var newArr = [];
  ...
  for (var i = 0; i < array.length; i += 1) {
    ...
    var sum = 0;
      ...
      newArr.push(sum); // nice job! this is a trickier one - how could you further deconstruct this? -MM
  }
  return newArr;
}
